...
const ProfilePage=()=>{
    ...
    useEffect(()=>{
        ...
        .then(data=>{
            if(data.users[0].displayName!==undefined&&data.users[0].displayName!==undefined){
    ...
    return (
        <div style={divstyling}>
            <Row>
                ...
                <Col xs={4} className="text-end mt-1">
                    <div>
                        ...
                        <div style={{backgroundColor:'tan',color:'black',borderRadius:'10px',width:'fit-content',textAlign:'justify',float:'right'}}><h6><i>
                            <h6 style={{color:'blue',display:'inline'}}>Congratulations</h6>, your profile is 100% completed. A complete profile has higher chances of landing a job.
                        </i></h6></div>}
                    </div>
                </Col>
            ...
            <div style={{display:'flex'}}>
                <form style={{backgroundColor:'white',marginLeft:'10%',padding:'10px',marginTop:'5rem',marginBottom:'27.5rem',width:'80%',border:'1px solid black',borderRadius:'10px',fontWeight:'bold'}} onSubmit={updateHandler}>
                    <header style={{textAlign:'center',marginTop:'5px'}}>Contact Details</header><button style={{color:'red',border:'1px solid red',borderRadius:'10px',float:'right',marginTop:'-25px'}} onClick={cancelHandler}>Cancel</button>
